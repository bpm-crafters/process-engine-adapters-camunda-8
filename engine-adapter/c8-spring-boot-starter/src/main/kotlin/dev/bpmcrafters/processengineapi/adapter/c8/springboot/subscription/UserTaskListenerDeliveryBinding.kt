...
open class UserTaskListenerDeliveryBinding(
  ...
  private val userTaskListenerGlobalRegistrationHelper: UserTaskListenerGlobalRegistrationHelper,
) {
  ...
  open fun scheduleUserTaskListenerSubscription(event: ApplicationStartedEvent) {
    ...
    userTaskListenerGlobalRegistrationHelper.registerIfEnabled()
